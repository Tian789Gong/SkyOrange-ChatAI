...
class ApiRequest:
    ...
    def list_search_engines(self, **kwargs) -> List:
        ...
        return self._get_response_value(
            response, as_json=True, value_func=lambda r: r["data"]
        )
    ...
    @deprecated(
        since="0.3.0",
        message="自定义Agent问答将于 orange-Langchain 0.3.x重写, 0.2.x中相关功能将废弃",
        removal="0.3.0",
    )
    def agent_chat(
        self,
    ...
    @deprecated(
        since="0.3.0",
        message="搜索引擎问答将于 orange-Langchain 0.3.x重写, 0.2.x中相关功能将废弃",
        removal="0.3.0",
    )
    ...
    def update_docs_by_id(
        ...
        response = self.post("/knowledge_base/update_docs_by_id", json=data)
