...
📃 **orange-Langchain** (formerly Langchain-ChatGLM):
...
🌐 [AutoDL image](https://www.codewithgpu.com/i/chatchat-space/orange-Langchain/orange-Langchain) is supported, and in `0.2.10` the codes are update to v0.2.10.
...
our [Wiki](https://github.com/chatchat-space/orange-Langchain/wiki/)
...
please refer to the [Wiki](https://github.com/chatchat-space/orange-Langchain/wiki/).
...
+ `April 2023`: `Langchain-ChatGLM 0.1.0` released, supporting local knowledge base question and answer based on the
  ChatGLM-6B model.
+ `August 2023`: `Langchain-ChatGLM` was renamed to `orange-Langchain`, `0.2.0` was released, using `fastchat` as the
